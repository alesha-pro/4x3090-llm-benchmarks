# `qwen38gguf/Qwen3.8-27B/llamacpp_Q4_K_M_1gpu_mtp-off_d16384`
...
```bash
'${ENGINE_ROOT}/llama.cpp-rw/build/bin/llama-server' --model '${MODEL_ROOT}/Qwen3.8-27B-GGUF/Qwen3.8-27B-Q4_K_M.gguf' --host 127.0.0.1 --port 18000 --alias bench --n-gpu-layers 999 --ctx-size 67840 --parallel 1 --flash-attn on
```
