# `qwen38gguf/Qwen3.8-27B/llamacpp_Q5_K_M_4gpu_d0`
...
| metric | value |
|---|---:|
| `output_tok_s` | 38.953529 |
| `decode_tok_s` | 38.953529 |
| `prefill_tok_s` | 3054.772458 |
...
```json
{
  "decode_stddev_ts": 0.041252,
  "depth_tokens": 0,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 0.69234,
  "repetitions": 3,
  "split_mode": "layer"
}
```
