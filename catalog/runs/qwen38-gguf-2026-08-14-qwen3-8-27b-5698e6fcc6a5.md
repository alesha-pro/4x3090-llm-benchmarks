# `qwen38gguf/Qwen3.8-27B/llamacpp_Q5_K_M_2gpu_d16384`
...
| metric | value |
|---|---:|
| `output_tok_s` | 36.978852 |
| `decode_tok_s` | 36.978852 |
| `prefill_tok_s` | 1705.470307 |
...
```json
{
  "decode_stddev_ts": 0.053235,
  "depth_tokens": 16384,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 0.215082,
  "repetitions": 3,
  "split_mode": "layer"
}
```
