# `ling3-flash/baseline/saturation-8192x256-c8`
...
| metric | value |
|---|---:|
| `output_tok_s` | 71.39648240381047 |
| `total_tok_s` | 2356.0839193257452 |
| `req_s` | 0.27889250938988464 |
| `ttft_p50_ms` | 14994.652040499204 |
| `ttft_p99_ms` | 24499.7611530016 |
| `itl_p50_ms` | 16.72061799763469 |
| `tpot_p50_ms` | 53.64575716275973 |
...
- `repo:llm-bench/results/daily-papers/2026-08-05/ling3-flash-int4-4x3090-saturation/exact/baseline/saturation-8192x256-c8.jsonl`
