# `depth/Qwen3.6-27B/llamacpp_2x-350W-262k-ub1024-q4_0-mtp2_d196608`
...
| metric | value |
|---|---:|
| `output_tok_s` | 27.413630999676606 |
| `decode_tok_s` | 27.413630999676606 |
| `prefill_tok_s` | 831.7969591034176 |
...
- `repo:llm-bench/results/qwen36-27b-depth-2026-08-04/2x-350W-262k-ub1024-q4_0-mtp2.json`

## Notes

depth curve; prefill and decode measured in one request at depth 196608; harness llm-bench/results/*/depth_bench.py
