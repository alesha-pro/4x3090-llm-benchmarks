# `qwen38gguf/Qwen3.8-27B/llamacpp_Q4_K_M_4gpu_d16384`
...
| metric | value |
|---|---:|
| `output_tok_s` | 41.462471 |
| `decode_tok_s` | 41.462471 |
| `prefill_tok_s` | 2669.193305 |
...
```json
{
  "decode_stddev_ts": 0.002032,
  "depth_tokens": 16384,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 4.316523,
  "repetitions": 3,
  "split_mode": "layer"
}
```
