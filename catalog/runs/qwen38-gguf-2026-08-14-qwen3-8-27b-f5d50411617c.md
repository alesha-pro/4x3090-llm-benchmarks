# `qwen38gguf/Qwen3.8-27B/llamacpp_Q4_K_M_2gpu_d65536`
...
| metric | value |
|---|---:|
| `output_tok_s` | 35.706209 |
| `decode_tok_s` | 35.706209 |
| `prefill_tok_s` | 1176.571609 |
...
```json
{
  "decode_stddev_ts": 0.058038,
  "depth_tokens": 65536,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 1.256225,
  "repetitions": 3,
  "split_mode": "layer"
}
```
