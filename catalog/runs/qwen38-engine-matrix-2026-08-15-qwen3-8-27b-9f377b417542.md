# `qwen38em/vllm-fp8/tp2-fp8-mtp2_d131072_c1`
...
| `output_tok_s` | 59.04 |
| `decode_tok_s` | 59.04 |
| `prefill_tok_s` | 1243.9 |
| `total_tok_s` | 0.66 |
| `ttft_p50_ms` | 105378.7 |
...
```json
{
  "aggregate_active_decode_rate_sum": 59.04,
  "aggregate_decode_window_tok_s": 59.04,
  "attempts": 2,
  "config": "tp2-fp8-mtp2",
  "cuda_graphs": true,
  ...
  "mtp": true,
  "prefill_tok_s_aggregate": 1243.9,
  "prefix_caching": false,
  "suite": "vllm-depth-autonomous-qwen38-fp8",
  "ttft_max_ms": 105378.7,
  "wall_s": 106.55
}
```
