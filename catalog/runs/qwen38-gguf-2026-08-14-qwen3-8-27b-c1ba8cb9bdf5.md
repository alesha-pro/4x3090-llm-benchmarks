# `qwen38gguf/Qwen3.8-27B/llamacpp_Q4_K_M_2gpu_d0`
...
| metric | value |
|---|---:|
| `output_tok_s` | 43.577814 |
| `decode_tok_s` | 43.577814 |
| `prefill_tok_s` | 2067.742822 |

## Launch command

```bash
'${ENGINE_ROOT}/llama.cpp-rw/build/bin/llama-bench' --model '${MODEL_ROOT}/Qwen3.8-27B-GGUF/Qwen3.8-27B-Q4_K_M.gguf' --n-gpu-layers 999 --flash-attn on --n-prompt 4096 --n-gen 128 --n-depth 0 --repetitions 3 -o json
```
...
```json
{
  "decode_stddev_ts": 0.039822,
  "depth_tokens": 0,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 2.640865,
  "repetitions": 3,
  "split_mode": "layer"
}
```
