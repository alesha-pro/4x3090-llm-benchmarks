# `ling3-flash/baseline/generation-1024x1024-c1`
...
| metric | value |
|---|---:|
| `output_tok_s` | 113.85698046330775 |
| `total_tok_s` | 227.7139609266155 |
| `req_s` | 0.11118845748369897 |
| `ttft_p50_ms` | 417.0778999978211 |
| `ttft_p99_ms` | 423.0940621744958 |
| `itl_p50_ms` | 8.368208502361085 |
| `tpot_p50_ms` | 8.37527209628744 |
...
- `repo:llm-bench/results/daily-papers/2026-08-05/ling3-flash-int4-4x3090-saturation/exact/baseline/generation-1024x1024-c1.jsonl`
