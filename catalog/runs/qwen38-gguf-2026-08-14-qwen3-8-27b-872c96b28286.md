# `qwen38gguf/Qwen3.8-27B/llamacpp_Q6_K_1gpu_d0`
...
| metric | value |
|---|---:|
| `output_tok_s` | 29.506241 |
| `decode_tok_s` | 29.506241 |
| `prefill_tok_s` | 1132.088379 |
...
```json
{
  "decode_stddev_ts": 0.03887,
  "depth_tokens": 0,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 1.900245,
  "repetitions": 3,
  "split_mode": "none"
}
```
