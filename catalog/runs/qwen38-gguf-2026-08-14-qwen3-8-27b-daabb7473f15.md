# `qwen38gguf/Qwen3.8-27B/llamacpp_Q4_K_M_2gpu_d16384`
...
| metric | value |
|---|---:|
| `output_tok_s` | 41.338481 |
| `decode_tok_s` | 41.338481 |
| `prefill_tok_s` | 1746.507678 |
...
```json
{
  "decode_stddev_ts": 0.064345,
  "depth_tokens": 16384,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 0.631349,
  "repetitions": 3,
  "split_mode": "layer"
}
```
