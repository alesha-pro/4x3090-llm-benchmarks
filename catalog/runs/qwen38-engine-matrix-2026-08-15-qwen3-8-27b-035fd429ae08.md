# `qwen38em/sglang-nvfp4/tp2-fp8-mtp4_d131072_c1`
...
| `output_tok_s` | 70.54 |
| `decode_tok_s` | 70.54 |
| `prefill_tok_s` | 1215.2 |
| `total_tok_s` | 0.4 |
| `ttft_p50_ms` | 107859.9 |
...
```json
{
  "aggregate_active_decode_rate_sum": 70.54,
  "aggregate_decode_window_tok_s": 70.54,
  "attempts": 2,
  "config": "tp2-fp8-mtp4",
  "cuda_graphs": true,
  ...
  "mtp": true,
  "prefill_tok_s_aggregate": 1215.2,
  "prefix_caching": false,
  "suite": "sglang-depth-autonomous-qwen38-nvfp4",
  "ttft_max_ms": 107859.9,
  "wall_s": 108.46
}
```
