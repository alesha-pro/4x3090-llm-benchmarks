# `qwen38gguf/Qwen3.8-27B/llamacpp_Q4_K_M_1gpu_d4096`
...
| metric | value |
|---|---:|
| `output_tok_s` | 39.100015 |
| `decode_tok_s` | 39.100015 |
| `prefill_tok_s` | 1178.720892 |
...
```json
{
  "decode_stddev_ts": 0.068069,
  "depth_tokens": 4096,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 0.273148,
  "repetitions": 3,
  "split_mode": "none"
}
```
