# `qwen38gguf/Qwen3.8-27B/llamacpp_Q6_K_4gpu_d16384`
...
| metric | value |
|---|---:|
| `output_tok_s` | 32.85342 |
| `decode_tok_s` | 32.85342 |
| `prefill_tok_s` | 2448.681429 |
...
```json
{
  "decode_stddev_ts": 0.015626,
  "depth_tokens": 16384,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 1.114701,
  "repetitions": 3,
  "split_mode": "layer"
}
```
