# `qwen38gguf/Qwen3.8-27B/llamacpp_Q5_K_M_4gpu_d4096`
...
| metric | value |
|---|---:|
| `output_tok_s` | 38.51693 |
| `decode_tok_s` | 38.51693 |
| `prefill_tok_s` | 2930.956468 |

## Launch command

```bash
'${ENGINE_ROOT}/llama.cpp-rw/build/bin/llama-bench' --model '${MODEL_ROOT}/Qwen3.8-27B-GGUF/Qwen3.8-27B-Q5_K_M.gguf' --n-gpu-layers 999 --flash-attn on --n-prompt 4096 --n-gen 128 --n-depth 4096 --repetitions 3 -o json
```
...
```json
{
  "decode_stddev_ts": 0.013863,
  "depth_tokens": 4096,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 7.715976,
  "repetitions": 3,
  "split_mode": "layer"
}
```
