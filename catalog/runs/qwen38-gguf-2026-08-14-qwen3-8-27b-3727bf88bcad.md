# `qwen38gguf/Qwen3.8-27B/llamacpp_Q6_K_4gpu_d0`
...
| metric | value |
|---|---:|
| `output_tok_s` | 34.222617 |
| `decode_tok_s` | 34.222617 |
| `prefill_tok_s` | 2865.646243 |
...
```json
{
  "decode_stddev_ts": 0.031782,
  "depth_tokens": 0,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 4.48634,
  "repetitions": 3,
  "split_mode": "layer"
}
```
