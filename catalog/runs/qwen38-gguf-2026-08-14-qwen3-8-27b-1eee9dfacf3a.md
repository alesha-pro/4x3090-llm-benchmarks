# `qwen38gguf/Qwen3.8-27B/llamacpp_Q5_K_M_2gpu_mtp-on`
...
```bash
'${ENGINE_ROOT}/llama.cpp-rw/build/bin/llama-server' --model '${MODEL_ROOT}/Qwen3.8-27B-GGUF/Qwen3.8-27B-Q5_K_M.gguf' --host 127.0.0.1 --port 18000 --alias bench --n-gpu-layers 999 --ctx-size 8192 --parallel 1 --flash-attn on --spec-type draft-mtp --spec-draft-n-max 3
```
