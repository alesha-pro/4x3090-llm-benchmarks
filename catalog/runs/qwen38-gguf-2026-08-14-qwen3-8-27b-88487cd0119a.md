# `qwen38gguf/Qwen3.8-27B/llamacpp_Q4_K_M_1gpu_d65536`
...
| metric | value |
|---|---:|
| `output_tok_s` | 33.206759 |
| `decode_tok_s` | 33.206759 |
| `prefill_tok_s` | 701.026307 |
...
```json
{
  "decode_stddev_ts": 0.056459,
  "depth_tokens": 65536,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 0.420705,
  "repetitions": 3,
  "split_mode": "none"
}
```
