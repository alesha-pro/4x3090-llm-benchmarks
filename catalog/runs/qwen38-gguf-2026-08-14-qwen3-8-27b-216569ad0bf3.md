# `qwen38gguf/Qwen3.8-27B/llamacpp_Q5_K_M_2gpu_d65536`
...
| metric | value |
|---|---:|
| `output_tok_s` | 32.4145 |
| `decode_tok_s` | 32.4145 |
| `prefill_tok_s` | 1153.793031 |
...
```json
{
  "decode_stddev_ts": 0.0569,
  "depth_tokens": 65536,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 4.021692,
  "repetitions": 3,
  "split_mode": "layer"
}
```
