# `inkling/Inkling-Small/llamacpp_IQ2_M_tp4x1_spec-none_d0_pl220_pp512`
...
|---|---:|
| `output_tok_s` | 646.47 |
| `prefill_tok_s` | 646.47 |

## Launch command

```bash
'${ENGINE_ROOT}/llama.cpp-inkling/build/bin/llama-bench' -m '${MODEL_ROOT}/Inkling-Small-GGUF/UD-IQ2_M/Inkling-Small-UD-IQ2_M-00001-of-00003.gguf' -ngl 99 -t 32 -fa 1 -p 512 -n 0 -r 2 -o md
```
