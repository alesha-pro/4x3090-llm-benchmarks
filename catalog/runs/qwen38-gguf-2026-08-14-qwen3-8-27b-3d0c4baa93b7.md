# `qwen38gguf/Qwen3.8-27B/llamacpp_Q4_K_M_4gpu_d0`
...
| metric | value |
|---|---:|
| `output_tok_s` | 43.705543 |
| `decode_tok_s` | 43.705543 |
| `prefill_tok_s` | 3167.230415 |
...
```json
{
  "decode_stddev_ts": 0.084516,
  "depth_tokens": 0,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 4.222814,
  "repetitions": 3,
  "split_mode": "layer"
}
```
