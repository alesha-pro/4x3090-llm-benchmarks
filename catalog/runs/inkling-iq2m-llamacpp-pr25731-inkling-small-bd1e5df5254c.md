# `inkling/Inkling-Small/llamacpp_IQ2_M_tp4x1_spec-none_d98304_pl220_pp8192_at_d98304`
...
|---|---:|
| `output_tok_s` | 419.56 |
| `prefill_tok_s` | 419.56 |

## Launch command

```bash
'${ENGINE_ROOT}/llama.cpp-inkling/build/bin/llama-bench' -m '${MODEL_ROOT}/Inkling-Small-GGUF/UD-IQ2_M/Inkling-Small-UD-IQ2_M-00001-of-00003.gguf' -ngl 99 -t 32 -fa 1 -p 8192 -n 0 -d 98304 -r 1 -o md
```
...
- `repo:llm-bench/results/inkling-small-iq2m-4x3090-2026-07-31/bench-deep.log`
