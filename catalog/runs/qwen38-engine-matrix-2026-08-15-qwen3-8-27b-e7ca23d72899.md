# `qwen38em/sglang-nvfp4/tp4-fp8-nomtp_d253952_c1`
...
| `prefill_tok_s` | 724.4 |
| `total_tok_s` | 0.15 |
| `ttft_p50_ms` | 350577.4 |

## Launch command

```bash
'${ENGINE_ROOT_ALT}/sglang-nvfp4-env/bin/sglang' serve --model-path '${MODEL_ROOT_ALT}/Qwen3.8-27B-NVFP4' --served-model-name bench --host 127.0.0.1 --port 18081 --tp-size 4 --context-length 262144 --mem-fraction-static 0.9 --max-running-requests 16 --chunked-prefill-size 8192 --cuda-graph-max-bs-prefill 256 --disable-radix-cache --disable-custom-all-reduce --language-only --quantization compressed-tensors --kv-cache-dtype fp8_e4m3 --reasoning-parser qwen3 --fp4-gemm-backend marlin
```
...
```json
{
  "aggregate_active_decode_rate_sum": 61.55,
  "aggregate_decode_window_tok_s": 61.55,
  "attempts": 1,
  ...
  "mtp": false,
  "prefill_tok_s_aggregate": 724.4,
  "prefix_caching": false,
  "suite": "sglang-depth-autonomous-qwen38-nvfp4",
  "ttft_max_ms": 350577.4,
  "wall_s": 351.43
}
```
