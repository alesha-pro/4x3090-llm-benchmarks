# `qwen38gguf/Qwen3.8-27B/llamacpp_Q5_K_M_1gpu_d4096`
...
| metric | value |
|---|---:|
| `output_tok_s` | 34.92948 |
| `decode_tok_s` | 34.92948 |
| `prefill_tok_s` | 1148.669601 |
...
```json
{
  "decode_stddev_ts": 0.047579,
  "depth_tokens": 4096,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 1.3454,
  "repetitions": 3,
  "split_mode": "none"
}
```
