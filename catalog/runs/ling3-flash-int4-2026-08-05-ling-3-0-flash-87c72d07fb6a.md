# `ling3-flash/baseline/saturation-32768x256-c1`
...
| metric | value |
|---|---:|
| `output_tok_s` | 16.655866874085575 |
| `total_tok_s` | 2148.606826757039 |
| `req_s` | 0.06506197997689678 |
| `ttft_p50_ms` | 15710.208331009198 |
| `ttft_p99_ms` | 15969.549889038608 |
| `itl_p50_ms` | 9.193769998091739 |
| `tpot_p50_ms` | 9.200200545070832 |
...
- `repo:llm-bench/results/daily-papers/2026-08-05/ling3-flash-int4-4x3090-saturation/exact/baseline/saturation-32768x256-c1.jsonl`
