# `ling3-flash/baseline/saturation-8192x256-c32`
...
| metric | value |
|---|---:|
| `output_tok_s` | 71.73999566395183 |
| `total_tok_s` | 2367.4198569104105 |
| `req_s` | 0.28023435806231184 |
| `ttft_p50_ms` | 93011.88811549946 |
| `ttft_p99_ms` | 109967.62223194062 |
| `itl_p50_ms` | 16.710506497474853 |
| `tpot_p50_ms` | 50.13298813725009 |
...
- `repo:llm-bench/results/daily-papers/2026-08-05/ling3-flash-int4-4x3090-saturation/exact/baseline/saturation-8192x256-c32.jsonl`
