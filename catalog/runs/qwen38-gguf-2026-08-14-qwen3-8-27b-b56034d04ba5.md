# `qwen38gguf/Qwen3.8-27B/llamacpp_Q4_K_M_1gpu_d0`
...
| metric | value |
|---|---:|
| `output_tok_s` | 39.618743 |
| `decode_tok_s` | 39.618743 |
| `prefill_tok_s` | 1232.994289 |
...
```json
{
  "decode_stddev_ts": 0.21275,
  "depth_tokens": 0,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 2.16886,
  "repetitions": 3,
  "split_mode": "none"
}
```
