# `ling3-flash/nextn/saturation-1024x256-c4`
...
| metric | value |
|---|---:|
| `output_tok_s` | 139.20894686016035 |
| `total_tok_s` | 696.0447343008017 |
| `req_s` | 0.5437849486725014 |
| `ttft_p50_ms` | 2943.5633730026893 |
| `ttft_p99_ms` | 5913.174056509888 |
| `itl_p50_ms` | 12.002507666087089 |
| `tpot_p50_ms` | 14.873490448985203 |
...
```json
{
  "accept_length": 3.0092165898617513,
  "chunked_prefill_size": 8192,
  "label": "saturation-1024x256-c4",
...
- `repo:llm-bench/results/daily-papers/2026-08-05/ling3-flash-int4-4x3090-saturation/nextn32k/nextn/saturation-1024x256-c4.jsonl`
