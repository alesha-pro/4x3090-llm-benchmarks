# `qwen38gguf/Qwen3.8-27B/llamacpp_Q6_K_1gpu_d16384`
...
| metric | value |
|---|---:|
| `output_tok_s` | 28.317591 |
| `decode_tok_s` | 28.317591 |
| `prefill_tok_s` | 968.210333 |
...
```json
{
  "decode_stddev_ts": 0.026125,
  "depth_tokens": 16384,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 0.664928,
  "repetitions": 3,
  "split_mode": "none"
}
```
