# `qwen38gguf/Qwen3.8-27B/llamacpp_Q4_K_M_4gpu_d4096`
...
| metric | value |
|---|---:|
| `output_tok_s` | 43.148309 |
| `decode_tok_s` | 43.148309 |
| `prefill_tok_s` | 3021.05991 |
...
```json
{
  "decode_stddev_ts": 0.011903,
  "depth_tokens": 4096,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 2.860086,
  "repetitions": 3,
  "split_mode": "layer"
}
```
