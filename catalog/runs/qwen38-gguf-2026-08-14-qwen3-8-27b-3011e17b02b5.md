# `qwen38gguf/Qwen3.8-27B/llamacpp_Q5_K_M_1gpu_d65536`
...
| metric | value |
|---|---:|
| `output_tok_s` | 30.11328 |
| `decode_tok_s` | 30.11328 |
| `prefill_tok_s` | 692.0847 |
...
```json
{
  "decode_stddev_ts": 0.057652,
  "depth_tokens": 65536,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 0.997858,
  "repetitions": 3,
  "split_mode": "none"
}
```
