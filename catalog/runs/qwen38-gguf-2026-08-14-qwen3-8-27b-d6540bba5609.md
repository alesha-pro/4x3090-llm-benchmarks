# `qwen38gguf/Qwen3.8-27B/llamacpp_Q4_K_M_1gpu_d16384`
...
| metric | value |
|---|---:|
| `output_tok_s` | 37.858977 |
| `decode_tok_s` | 37.858977 |
| `prefill_tok_s` | 1044.639331 |

## Launch command

```bash
'${ENGINE_ROOT}/llama.cpp-rw/build/bin/llama-bench' --model '${MODEL_ROOT}/Qwen3.8-27B-GGUF/Qwen3.8-27B-Q4_K_M.gguf' --n-gpu-layers 999 --flash-attn on --n-prompt 4096 --n-gen 128 --n-depth 16384 --repetitions 3 -o json
```
...
```json
{
  "decode_stddev_ts": 0.063559,
  "depth_tokens": 16384,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 0.475527,
  "repetitions": 3,
  "split_mode": "none"
}
```
