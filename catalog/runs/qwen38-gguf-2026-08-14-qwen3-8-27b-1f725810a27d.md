# `qwen38gguf/Qwen3.8-27B/llamacpp_Q4_K_M_2gpu_d131072`
...
| metric | value |
|---|---:|
| `output_tok_s` | 30.255649 |
| `decode_tok_s` | 30.255649 |
| `prefill_tok_s` | 789.80542 |
...
```json
{
  "decode_stddev_ts": 0.034008,
  "depth_tokens": 131072,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 1.883979,
  "repetitions": 3,
  "split_mode": "layer"
}
```
