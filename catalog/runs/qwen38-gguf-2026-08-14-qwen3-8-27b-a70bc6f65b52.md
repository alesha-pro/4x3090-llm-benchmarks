# `qwen38gguf/Qwen3.8-27B/llamacpp_Q5_K_M_4gpu_d16384`
...
| metric | value |
|---|---:|
| `output_tok_s` | 37.165413 |
| `decode_tok_s` | 37.165413 |
| `prefill_tok_s` | 2591.716792 |
...
```json
{
  "decode_stddev_ts": 0.018597,
  "depth_tokens": 16384,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 5.058207,
  "repetitions": 3,
  "split_mode": "layer"
}
```
