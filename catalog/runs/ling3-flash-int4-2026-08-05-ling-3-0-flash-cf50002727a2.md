# `ling3-flash/baseline/saturation-1024x256-c4`
...
| metric | value |
|---|---:|
| `output_tok_s` | 150.55520475516258 |
| `total_tok_s` | 752.776023775813 |
| `req_s` | 0.5881062685748538 |
| `ttft_p50_ms` | 3691.958991505089 |
| `ttft_p99_ms` | 5865.501880275988 |
| `itl_p50_ms` | 12.122141495638061 |
| `tpot_p50_ms` | 12.154995280377312 |
...
- `repo:llm-bench/results/daily-papers/2026-08-05/ling3-flash-int4-4x3090-saturation/exact/baseline/saturation-1024x256-c4.jsonl`
