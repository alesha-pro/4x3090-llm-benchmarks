# `qwen38gguf/Qwen3.8-27B/llamacpp_Q6_K_1gpu_d4096`
...
| metric | value |
|---|---:|
| `output_tok_s` | 29.072058 |
| `decode_tok_s` | 29.072058 |
| `prefill_tok_s` | 1083.866903 |
...
```json
{
  "decode_stddev_ts": 0.011423,
  "depth_tokens": 4096,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 1.699798,
  "repetitions": 3,
  "split_mode": "none"
}
```
