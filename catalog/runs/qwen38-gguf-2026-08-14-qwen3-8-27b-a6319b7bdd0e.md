# `qwen38gguf/Qwen3.8-27B/llamacpp_Q5_K_M_1gpu_d0`
...
| metric | value |
|---|---:|
| `output_tok_s` | 35.452656 |
| `decode_tok_s` | 35.452656 |
| `prefill_tok_s` | 1201.34997 |
...
```json
{
  "decode_stddev_ts": 0.112655,
  "depth_tokens": 0,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 2.527561,
  "repetitions": 3,
  "split_mode": "none"
}
```
