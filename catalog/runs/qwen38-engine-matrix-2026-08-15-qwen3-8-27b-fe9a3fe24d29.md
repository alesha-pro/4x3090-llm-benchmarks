# `qwen38em/vllm-nvfp4/tp2-fp8-mtp2_d131072_c1`
...
| `output_tok_s` | 75.28 |
| `decode_tok_s` | 75.28 |
| `prefill_tok_s` | 1269.2 |
| `total_tok_s` | 0.47 |
| `ttft_p50_ms` | 103273.1 |
...
```json
{
  "aggregate_active_decode_rate_sum": 75.28,
  "aggregate_decode_window_tok_s": 75.28,
  "attempts": 2,
  "config": "tp2-fp8-mtp2",
  "cuda_graphs": true,
  ...
  "mtp": true,
  "prefill_tok_s_aggregate": 1269.2,
  "prefix_caching": false,
  "suite": "vllm-depth-autonomous-qwen38-nvfp4",
  "ttft_max_ms": 103273.1,
  "wall_s": 103.92
}
```
