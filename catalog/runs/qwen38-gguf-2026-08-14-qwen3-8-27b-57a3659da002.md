# `qwen38gguf/Qwen3.8-27B/llamacpp_Q6_K_4gpu_d65536`
...
| metric | value |
|---|---:|
| `output_tok_s` | 29.227152 |
| `decode_tok_s` | 29.227152 |
| `prefill_tok_s` | 1679.554856 |
...
```json
{
  "decode_stddev_ts": 0.021066,
  "depth_tokens": 65536,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 0.332001,
  "repetitions": 3,
  "split_mode": "layer"
}
```
