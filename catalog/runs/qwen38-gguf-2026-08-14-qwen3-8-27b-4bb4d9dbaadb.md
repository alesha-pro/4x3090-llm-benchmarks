# `qwen38gguf/Qwen3.8-27B/llamacpp_Q6_K_4gpu_d4096`
...
| metric | value |
|---|---:|
| `output_tok_s` | 33.896044 |
| `decode_tok_s` | 33.896044 |
| `prefill_tok_s` | 2747.868815 |

## Launch command

```bash
'${ENGINE_ROOT}/llama.cpp-rw/build/bin/llama-bench' --model '${MODEL_ROOT}/Qwen3.8-27B-GGUF/Qwen3.8-27B-Q6_K.gguf' --n-gpu-layers 999 --flash-attn on --n-prompt 4096 --n-gen 128 --n-depth 4096 --repetitions 3 -o json
```
...
```json
{
  "decode_stddev_ts": 0.00567,
  "depth_tokens": 4096,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 2.72694,
  "repetitions": 3,
  "split_mode": "layer"
}
```
