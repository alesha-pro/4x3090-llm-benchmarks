# `qwen38gguf/Qwen3.8-27B/llamacpp_Q5_K_M_2gpu_d4096`
...
| metric | value |
|---|---:|
| `output_tok_s` | 38.32871 |
| `decode_tok_s` | 38.32871 |
| `prefill_tok_s` | 1922.362029 |
...
```json
{
  "decode_stddev_ts": 0.062189,
  "depth_tokens": 4096,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 1.788758,
  "repetitions": 3,
  "split_mode": "layer"
}
```
