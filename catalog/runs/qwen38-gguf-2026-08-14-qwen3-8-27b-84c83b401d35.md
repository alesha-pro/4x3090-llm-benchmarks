# `qwen38gguf/Qwen3.8-27B/llamacpp_Q6_K_2gpu_d65536`
...
| metric | value |
|---|---:|
| `output_tok_s` | 28.885945 |
| `decode_tok_s` | 28.885945 |
| `prefill_tok_s` | 1109.129658 |

## Launch command

```bash
'${ENGINE_ROOT}/llama.cpp-rw/build/bin/llama-bench' --model '${MODEL_ROOT}/Qwen3.8-27B-GGUF/Qwen3.8-27B-Q6_K.gguf' --n-gpu-layers 999 --flash-attn on --n-prompt 4096 --n-gen 128 --n-depth 65536 --repetitions 3 -o json
```
...
```json
{
  "decode_stddev_ts": 0.036053,
  "depth_tokens": 65536,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 0.261087,
  "repetitions": 3,
  "split_mode": "layer"
}
```
