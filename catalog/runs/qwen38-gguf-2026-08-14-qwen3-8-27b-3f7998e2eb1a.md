# `qwen38gguf/Qwen3.8-27B/llamacpp_Q5_K_M_2gpu_d131072`
...
| metric | value |
|---|---:|
| `output_tok_s` | 27.809467 |
| `decode_tok_s` | 27.809467 |
| `prefill_tok_s` | 781.957505 |
...
```json
{
  "decode_stddev_ts": 0.060487,
  "depth_tokens": 131072,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 1.015368,
  "repetitions": 3,
  "split_mode": "layer"
}
```
