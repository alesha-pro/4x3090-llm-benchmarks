# `inkling/Inkling-Small/llamacpp_IQ2_M_tp4x1_spec-none_d16384_pl220_tg64_at_d16384`
...
```bash
'${ENGINE_ROOT}/llama.cpp-inkling/build/bin/llama-bench' -m '${MODEL_ROOT}/Inkling-Small-GGUF/UD-IQ2_M/Inkling-Small-UD-IQ2_M-00001-of-00003.gguf' -ngl 99 -t 32 -fa 1 -p 0 -n 64 -d 16384 -r 2 -o md
```
