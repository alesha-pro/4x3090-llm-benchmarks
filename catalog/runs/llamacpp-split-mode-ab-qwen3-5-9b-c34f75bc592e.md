# `smab/Qwen3.5-9B/llamacpp_GGUF-Q8_0_sm-tensor_tp4x1_spec-none_pl220_pp2048`
...
| metric | value |
|---|---:|
| `output_tok_s` | 2112.96 |
| `prefill_tok_s` | 2112.96 |

## Launch command

```bash
'${ENGINE_ROOT}/llama.cpp-inkling/build/bin/llama-bench' -m '${MODEL_ROOT}/Qwen3.5-9B-GGUF/Qwen3.5-9B-Q8_0.gguf' -ngl 99 -t 32 -fa 1 -sm tensor -p 2048 -n 0 -r 3 -o md
```
