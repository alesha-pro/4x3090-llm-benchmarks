# `qwen38em/sglang-nvfp4/tp2-bf16-nomtp_d253952_c1`
...
| `output_tok_s` | 37.07 |
| `decode_tok_s` | 37.07 |
| `prefill_tok_s` | 1032.7 |
| `total_tok_s` | 0.19 |
| `ttft_p50_ms` | 245918.6 |

## Launch command

```bash
'${ENGINE_ROOT_ALT}/sglang-nvfp4-env/bin/sglang' serve --model-path '${MODEL_ROOT_ALT}/Qwen3.8-27B-NVFP4' --served-model-name bench --host 127.0.0.1 --port 18081 --tp-size 2 --context-length 262144 --mem-fraction-static 0.9 --max-running-requests 16 --chunked-prefill-size 8192 --cuda-graph-max-bs-prefill 256 --disable-radix-cache --disable-custom-all-reduce --language-only --quantization compressed-tensors --kv-cache-dtype bf16 --reasoning-parser qwen3 --fp4-gemm-backend marlin
```
...
```json
{
  "aggregate_active_decode_rate_sum": 37.07,
  "aggregate_decode_window_tok_s": 37.07,
  "attempts": 1,
  ...
  "mtp": false,
  "prefill_tok_s_aggregate": 1032.7,
  "prefix_caching": false,
  "suite": "sglang-depth-autonomous-qwen38-nvfp4",
  "ttft_max_ms": 245918.6,
  "wall_s": 247.2
}
```
