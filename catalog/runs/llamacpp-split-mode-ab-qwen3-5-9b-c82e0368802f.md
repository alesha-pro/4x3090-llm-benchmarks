# `smab/Qwen3.5-9B/llamacpp_GGUF-Q8_0_sm-tensor_tp4x1_spec-none_pl220_pp512`
...
| metric | value |
|---|---:|
| `output_tok_s` | 2176.62 |
| `prefill_tok_s` | 2176.62 |

## Launch command

```bash
'${ENGINE_ROOT}/llama.cpp-inkling/build/bin/llama-bench' -m '${MODEL_ROOT}/Qwen3.5-9B-GGUF/Qwen3.5-9B-Q8_0.gguf' -ngl 99 -t 32 -fa 1 -sm tensor -p 512 -n 0 -r 3 -o md
```
