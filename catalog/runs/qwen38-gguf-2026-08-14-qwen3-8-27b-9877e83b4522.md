# `qwen38gguf/Qwen3.8-27B/llamacpp_Q6_K_2gpu_d4096`
...
| metric | value |
|---|---:|
| `output_tok_s` | 33.379232 |
| `decode_tok_s` | 33.379232 |
| `prefill_tok_s` | 1789.534486 |
...
```json
{
  "decode_stddev_ts": 0.048167,
  "depth_tokens": 4096,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 5.314713,
  "repetitions": 3,
  "split_mode": "layer"
}
```
