# `ling3-flash/baseline/saturation-1024x256-c8`
...
| metric | value |
|---|---:|
| `output_tok_s` | 275.3160950464699 |
| `total_tok_s` | 1376.5804752323497 |
| `req_s` | 1.075453496275273 |
| `ttft_p50_ms` | 3190.265202494629 |
| `ttft_p99_ms` | 3292.6043036568444 |
| `itl_p50_ms` | 16.576261004956905 |
| `tpot_p50_ms` | 16.614597192172223 |
...
- `repo:llm-bench/results/daily-papers/2026-08-05/ling3-flash-int4-4x3090-saturation/exact/baseline/saturation-1024x256-c8.jsonl`
