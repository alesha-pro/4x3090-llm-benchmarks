# `qwen38gguf/Qwen3.8-27B/llamacpp_Q6_K_4gpu_d131072`
...
| metric | value |
|---|---:|
| `output_tok_s` | 25.497219 |
| `decode_tok_s` | 25.497219 |
| `prefill_tok_s` | 1146.267183 |
...
```json
{
  "decode_stddev_ts": 0.029765,
  "depth_tokens": 131072,
  "flash_attn": true,
  "harness": "release-watch/bench_depth.sh (llama-bench)",
  "n_gpu_layers": 999,
  "prefill_stddev_ts": 1.214124,
  "repetitions": 3,
  "split_mode": "layer"
}
```
