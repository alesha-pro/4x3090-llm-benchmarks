# `ling3-flash/baseline/saturation-1024x256-c16`
...
| metric | value |
|---|---:|
| `output_tok_s` | 295.94467342395336 |
| `total_tok_s` | 1479.7233671197666 |
| `req_s` | 1.1560338805623178 |
| `ttft_p50_ms` | 4737.26054099825 |
| `ttft_p99_ms` | 13306.359980648704 |
| `itl_p50_ms` | 20.714697500807233 |
| `tpot_p50_ms` | 20.874499496073675 |
...
- `repo:llm-bench/results/daily-papers/2026-08-05/ling3-flash-int4-4x3090-saturation/exact/baseline/saturation-1024x256-c16.jsonl`
